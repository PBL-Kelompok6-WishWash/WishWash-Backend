...
type Layanan struct {
	...
	WarnaLayanan     string  `gorm:"type:varchar(7);default:'#00BCD4';column:warna_layanan" json:"warna_layanan"`
	DeskripsiLayanan string  `gorm:"type:text;column:deskripsi_layanan" json:"deskripsi_layanan"`
